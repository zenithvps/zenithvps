        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-secondary-300 leading-relaxed">
              Empowering businesses with reliable, scalable, and secure cloud hosting solutions.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-secondary-300">
              <li><a href="#" className="hover:text-white transition-colors">Cloud Compute</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Cloud Storage</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Managed Database</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Cloud Networking</a></li>
